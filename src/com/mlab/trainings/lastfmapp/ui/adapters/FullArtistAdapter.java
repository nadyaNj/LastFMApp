...
/**
 * Created by nadya on 7/23/14.
 */
public class FullArtistAdapter extends BaseAdapter {
    ...
    public FullArtistAdapter(Context context)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(position == artists.size()) {
            convertView = inflater.inflate(R.layout.about_artist, parent, false);
